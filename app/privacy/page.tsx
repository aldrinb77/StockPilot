  ...
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-12 mb-20 animate-in fade-in space-y-8 bg-[#131722]/80 border border-gray-800 rounded-xl mt-8">
      ...
      <div className="prose prose-invert prose-gray max-w-none text-gray-300">
        ...
        <p>If you choose to authenticate via Clerk, basic profile information (such as your email address) is used securely to manage your account access limits and God-Mode settings. This data is protected by industry-standard encryption protocols through Clerk.</p>
